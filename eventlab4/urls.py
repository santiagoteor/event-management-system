"""
URL configuration for eventlab4 project.
...
from eventlab4.views import EventListCreateView, EventDetailView

urlpatterns = [
    path('admin/', admin.site.urls),  # Add this line to include the admin site
